...
public:
            ...
            ParamServer("lio_sam_imu_preintegration", options)
    {
        ...
        imuIntegratorImu_ = std::make_unique<gtsam::PreintegratedImuMeasurements>(p, prior_imu_bias); // IMU integration for IMU message thread
        imuIntegratorOpt_ = std::make_unique<gtsam::PreintegratedImuMeasurements>(p, prior_imu_bias); // IMU integration for optimization
